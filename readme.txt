...
6. Mở trình duyệt và truy cập vào địa chỉ: http://localhost:8888 để bắt đầu chạy demo
7. Thông tin hướng dẫn kết nối tham khảo thêm tại địa chỉ: http://sandbox.vnpayment.vn/apis/